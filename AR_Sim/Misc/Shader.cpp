...
{
	//std::cout << "But the setUniform(std::string sName, const glm::mat4 mMatrix) function normally works" << std::endl;
	int iLoc = glGetUniformLocation(uiProgram, sName.c_str());
